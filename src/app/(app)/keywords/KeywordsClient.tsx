    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <select
          ...
          onChange={e => { setSelectedCategory(e.target.value); setSelectedCategoryDetail('') }}
        ...
        <button
          onClick={() => { setForm({ ...EMPTY_FORM, category: effectiveCategory }); setShowAdd(true) }}
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  <button onClick={() => startEdit(k)}
                    className="text-gray-300 hover:text-gray-500 focus:outline-none shrink-0">
